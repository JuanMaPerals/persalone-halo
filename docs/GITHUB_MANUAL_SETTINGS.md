...
| Checks requeridos | Añadir como checks requeridos `verify` y `secret-scan` cuando los workflows hayan completado su primera ejecución. | No permite merge si falla análisis, tests o escaneo. | Ruleset con los checks seleccionados. |
